...
/**
 * Shows a "simulate genotype probabilities" dialog
 * @author <A HREF="mailto:keith.sheppard@jax.org">Keith Sheppard</A>
 */
public class SimulateGenotypeProbabilitiesAction
...
implements ProjectChangeListener
{
     ...
     * Constructor
     */
    public SimulateGenotypeProbabilitiesAction()
    {
        this(null);
    }
    ...
    public SimulateGenotypeProbabilitiesAction(
            Cross selectedCross)
    {
        super("Simulate Genotype Probabilities...");
        ...
        SwingUtilities.invokeLater(
                new Runnable()
                {
                    public void run()
                    {
                        ...
                        Cross selectedCross =
                            SimulateGenotypeProbabilitiesAction.this.selectedCross;
                        if(selectedCross == null)
                        {
                        ...
                        ImputationDialog simGenoprobDialog =
                            new ImputationDialog(
                                    QTL.getInstance().getApplicationFrame(),
                                    crosses,
                                    selectedCross);
                        simGenoprobDialog.setVisible(true);
                    }
                });
    }
    ...
    public void projectChangeOccurred(ProjectManager projectManager)
    {
        ...
        SwingUtilities.invokeLater(new Runnable()
        {
            public void run()
            {
                SimulateGenotypeProbabilitiesAction.this.setEnabled(anyCrosses);
            }
        });
    }
}
